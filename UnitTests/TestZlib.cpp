...
{
	std::vector<uint8_t> input1 = { 0b00100101, 0b01000010 };
...
{
	std::vector<uint8_t> input1 = { 0b10100100, 0b01000010 };
...
{
	std::vector<uint8_t> input1 = { 0b00110010, 0b00001110, 0b00001111, 0b00111110 };
...
{
	std::vector<uint8_t> input1 = { 0b01001100, 0b01110000, 0b11110000, 0b01111100 };
